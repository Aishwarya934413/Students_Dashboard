...
function EmpList(){
   ...
   useEffect(()=>{
    //   fetch("http://localhost:3006/Employee")
      fetch("https://json-res-apis.onrender.com/Student")
...
//    fetch("http://localhost:3006/Employee/"+id,{
    fetch("https://json-res-apis.onrender.com/Student/"+id,{
    method:"DELETE"
   })
   .then((s)=>{
   ...
   const searchData= async (e)=>{
    ...
    return await axios.get(`https://json-res-apis.onrender.com/Student?q=${value}`)
    .then((res)=>{
        console.log(res)
        setData(res.data)
        setValue("")
   ...
   const sortData= async(e)=>{
    ...
    return await axios.get(`https://json-res-apis.onrender.com/Student?_sort=${value}&_order=asc`)
    .then((res)=>{
        console.log(res)
        setData(res.data)
